...
export default function page() {
  ...
  return (
    <section className="flex flex-col gap-10 w-full">
      ...
      <p className='text-text-muted text-sm leading-6 mb-8'>Here's a glimpse of the technologies I've worked with. Each stack represents a different area of development, from building interactive user interfaces to creating robust backend systems.</p>
